...
static void CompileShaders(TempGraphicsData* graphicsData){
...
static void CreateVertexBuffer(TempGraphicsData* graphicsData){
...
static void CreateIndexBuffer(TempGraphicsData* graphicsData){
